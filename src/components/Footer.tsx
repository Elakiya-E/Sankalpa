    ...
    return (
        <footer className="footer">
            <div className="container grid grid-cols-4">
                <div>
                    <h3>{settings?.title || "Sankalpa Care"}</h3>
            ...
            <div className="container footer-bottom">
                <p>&copy; {new Date().getFullYear()} {settings?.footerText || "Sankalpa Care. All rights reserved."} | <Link href="/privacy">Privacy Policy</Link> | <Link href="/accessibility">Accessibility</Link></p>
            </div>
        </footer>
    );
}
