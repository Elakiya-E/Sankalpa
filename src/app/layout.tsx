...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    return {
      title: settings?.seo?.metaTitle || settings?.title || "Sankalpa Care | Premium Psychotherapy & Counseling in Tamil Nadu",
      ...
      keywords: settings?.seo?.keywords?.join(", ") || "therapy, counseling, psychotherapy, mental health, Tamil Nadu, emotional wellness, Sankalpa Care",
      openGraph: {
    ...
    return {
      title: "Sankalpa Care | Premium Psychotherapy & Counseling in Tamil Nadu",
